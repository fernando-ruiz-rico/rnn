...
def obtener_modelo():
    """Gestiona la carga o el entrenamiento del modelo."""
    global modelo
    
    # 1. Si ya está en memoria RAM, usarlo.
    if modelo: return modelo

    # 2. Si existe el archivo guardado, cargarlo.
    ...
    # 3. Si no existe, entrenar desde cero.
    X, y = cargar_datos()
    modelo = crear_modelo()
    
    # EarlyStopping: Si la IA no mejora durante 3 épocas, para el entrenamiento.
    # Esto evita perder tiempo y el "overfitting" (sobreajuste).
